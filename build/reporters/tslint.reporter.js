...
module.exports = function (_Reporter) {
  _inherits(TSLintReporter, _Reporter);

  function TSLintReporter(options, projectName) {
    _classCallCheck(this, TSLintReporter);

    var _this = _possibleConstructorReturn(this, (TSLintReporter.__proto__ || Object.getPrototypeOf(TSLintReporter)).call(this, options, projectName));

    _this.linterName = 'TSLint';
    return _this;
  }

  _createClass(TSLintReporter, [{
    key: 'launch',
    ...
    value: function processFile(file) {
      ...
      var configuration = TSLint.Configuration.findConfiguration(this.options.rulesFile || null, file).results;
      ...
      try {
        for (var _iterator = result.failures[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
